    ...
    <div className="row g-4">
      ...
      <div className="col-12 col-md-6 col-lg-2">
        <div className="d-flex align-items-center mb-3 logo">
          <img src='/img/favicon.png'/> Home~Hub
        </div>
        <p className='text-light'>Home Hub is your trusted real estate partner, offering premium homes, rentals, and investment properties with expert guidance and transparent service. Whether you're buying, selling, or renting, we bring you closer to the home you deserve.</p>
        <p><CiLocationOn className='me-2'/>Gomti-Nagar,Lucknow,India. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;States</p>
        <p><LuPhoneCall className='me-2'/>0522-886072</p>
        <p><BsEnvelope className='me-2'/>homehub@gmail.com</p>
