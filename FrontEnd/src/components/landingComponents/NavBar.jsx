  ...
  if (useData?.userType == "admin") {
    return (<>
      <nav className="navbar navbar-expand-sm bg-white border-bottom shadow-sm sticky-top">
        <div className="container navbarh">
          <div className="navbar-brand text-danger fw-bold d-flex align-items-center" >
            <img src="/public/img/mainlogo.jpg" alt="Logo" height={50} /> &nbsp;<b className='font text-center'>Home-Hub</b>
          </div>
    ...
    return (
      <>
        <nav className="navbar navbar-expand-sm bg-white border-bottom shadow-sm sticky-top">
          <div className="container">
            <div className="navbar-brand text-danger fw-bold d-flex align-items-center" >
              <img src="/public/img/mainlogo.jpg" alt="Logo" height={60} /> &nbsp;<b className='font text-center'>Home-Hub</b>
            </div>
            <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav">
              <span className="navbar-toggler-icon"></span>
            </button>
            <div className="mx-5 collapse navbar-collapse" id="navbarNav">
              <ul className="navbar-nav me-auto mb-2 mb-sm-0">
                <li className="nav-item nav1"><Link className="nav-link fs-4 fw-bold" to="/">Home</Link></li>
                <li className="nav-item nav1"><Link className="nav-link fs-4 fw-bold" to="/about">About</Link></li>
                <li className="nav-item nav1"><Link className="nav-link fs-4 fw-bold" to="/services">Services</Link></li>
                <li className="nav-item nav1"><Link className="nav-link fs-4 fw-bold" to="/property">Property</Link></li>
                <li className="nav-item nav1"><Link className="nav-link fs-4 fw-bold" to="/ContactUs">ContactUs</Link></li>
              </ul>
